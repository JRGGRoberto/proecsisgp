...
$dados .= "<link rel='stylesheet' href='https://sistemaproec.unespar.edu.br/pdf-php/css/custom.css'";
$dados .= "<title>Celke - Gerar PDF</title>";
$dados .= "</head>";
$dados .= "<body>";
$dados .= "<h1>Listar os Usuário</h1>";

$dados .= "<img src='https://sistemaproec.unespar.edu.br/pdf-php/imagens/celke.jpg'><br>";
