  ...
  <div class="card-header">
    ...
    <div id="p'. $proj->id  .'" class="collapse" data-parent="#accordion">
      ...
      '<hr>
        ...
        $resultados .=  
      '<hr>
        Projeto postado para o colegiado de '. $nomecol['nome'];
    ...
    <form method="get">
      ...
      <div class="row my-2">
        ...
        <div class="col">
          ...
          <select name="linha" id="linha" class="form-control form-control-sm">
            <option value=""></option>
            <?=$propOptions?>
          <select>
...
function printSub(data){
  ...
  modalFooter.innerHTML = data.innerHTML = `
          ...
          <form method="get" action="submeter.php?">
...
function writeNumber(elementId) {
  ...
  function showLimpar(){
    ...
    if((titulo.length > 0 ) | (colegiado.length > 0)| (area.length > 0)| (linha.length > 0) ) {
