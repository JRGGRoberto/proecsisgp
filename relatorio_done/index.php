...
$qntHistoRel = HistRelatorios::getQntdRegistros($where);

// paginação
$obPagination = new Pagination($qntHistoRel, $_GET['pagina'] ?? 1, 10);

$historicoRel = HistRelatorios::getRegistros($where, 'created_at desc', $obPagination->getLimite());
