...
<?php }
    ...
    ?>      
      ...
      <div class="form-group">
        ...
        <input type="number" min=0 max=44 class="form-control col-2"  required name="ch_semanal" value="<?php echo !empty($relatorio->ch_semanal) ? $relatorio->ch_semanal : '0'; ?>" <?php echo $editar; ?>>
      </div>
      ...
      <div class="form-group">
        ...
        <table>
          ...
          <tr>
            ...
            <td><input type="number" min=0 max=44 class="form-control" name="dim_mem_com_ex" value="<?php echo is_null($relatorio->dim_mem_com_ex) ? 0 : $relatorio->dim_mem_com_ex; ?>" <?php echo $editar; ?> ></td>
          </tr>
          <tr>
            <th>Discentes</th>
            <td><input type="number" min=0 max=44 class="form-control" name="dim_disc" value="<?php echo is_null($relatorio->dim_disc) ? 0 : $relatorio->dim_disc; ?>" <?php echo $editar; ?> ></td>
          </tr>
          <tr>
            <th>Docentes</th>
            <td><input type="number" min=0 max=44 class="form-control" name="dim_doce" value="<?php echo is_null($relatorio->dim_doce) ? 0 : $relatorio->dim_doce; ?>"  <?php echo $editar; ?> ></td>
          </tr>
          <tr>
            <th>Agentes universitários e Estagiários</th>
            <td><input type="number" min=0 max=44 class="form-control" name="dim_agent_estag" value="<?php echo is_null($relatorio->dim_agent_estag) ? 0 : $relatorio->dim_agent_estag; ?>"  <?php echo $editar; ?> ></td>
          </tr>
        </table>
      </div>
