...
class MicroCred_proj
{
    ...
    public function cadastrar()
    {
        ...
        $obDatabase = new Database('microcredenciais_proj');
        $obDatabase->insert([
            'id' => $newId,
            'nome' => $this->nome,
    ...
    {
        return (new Database('microcredenciais_proj'))->update('id = "'.$this->id.'" ', [
            'nome' => $this->nome,
            'link' => $this->link,
            'programa' => $this->programa,
    ...
    {
        return (new Database('microcredenciais_proj'))->delete('id = '.$this->id);
    }
    ...
    {
        return (new Database('microcredenciais_proj'))->select($where, $order, $limit)
    ...
    public static function get($id)
    {
        ...
        return (new Database('microcredenciais_proj'))->select($where)
    ...
    {
        return (new Database('microcredenciais_proj'))->select($where, null, null, 'COUNT(*) as qtd')
                                      ->fetchObject()
                                      ->qtd;
    }
}
