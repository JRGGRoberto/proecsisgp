...
class MicroCred_pontu
{
    ...
    public function cadastrar()
    {
        ...
        $obDatabase = new Database('microcredenciais_pontu');
        $obDatabase->insert([
    ...
    {
        return (new Database('microcredenciais_pontu'))->update('(proj_id, aval_id)  = ("'.$this->proj_id.'", "'.$this->aval_id.'") ', [
            'qn1' => $this->qn1,
            'qn2' => $this->qn2,
            'qn3' => $this->qn3,
            'qn4' => $this->qn4,
    ...
    {
        return (new Database('microcredenciais_pontu'))->delete('(proj_id, aval_id)  = ("'.$this->proj_id.'", "'.$this->aval_id.'") ');
    }
    ...
    {
        return (new Database('microcredenciais_v'))->select($where, $order, $limit)
    ...
    public static function get($id, $aval_id)
    {
        ...
        return (new Database('microcredenciais_pontu'))->select($where)
    ...
    {
        return (new Database('microcredenciais_v'))->select($where, null, null, 'COUNT(*) as qtd')
                                      ->fetchObject()
                                      ->qtd;
    }
}
