...
class MicroCred_avaliadores
{
    ...
    public function cadastrar()
    {
        ...
        $obDatabase = new Database('microcredenciais_avaliadores');
        $obDatabase->insert([
            'id' => $this->id,
            'ativo' => $this->ativo,
    ...
    {
        return (new Database('microcredenciais_avaliadores'))->update('id = "'.$this->id.'" ', [
            'ativo' => $this->ativo,
    ...
    {
        return (new Database('microcredenciais_avaliadores'))->delete('id = '.$this->id);
    }
    ...
    {
        return (new Database('microcredenciais_avaliadores'))->select($where, $order, $limit)
    ...
    public static function get($id, $where = null)
    {
        ...
        return (new Database('microcredenciais_avaliadores'))->select($where1)
    ...
    {
        return (new Database('microcredenciais_avaliadores'))->select($where, null, null, 'COUNT(*) as qtd')
                                      ->fetchObject()
                                      ->qtd;
    }
}
