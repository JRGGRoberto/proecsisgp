...
$acesso1 = $user['adm'] == '1' ? 1 : 0;
$acesso2 = $user['config'] == '3' ? 1 : 0;

if ($acesso1 + $acesso2 == 0) {
    header('location: ../');
    exit;
}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Inclusão de projetos aprovados por trâmite externo</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <!-- Modal body -->
      <div class="modal-body">
        
<p>Este formulário destina-se ao cadastro de projetos que já foram aprovados por outros meios, fora do sistema.</p>

<p>O projeto será registrado diretamente com o status correspondente à sua vigência atual (a iniciar, em andamento ou finalizado).</p>

<p>É obrigatório anexar o documento oficial que comprove a aprovação do projeto pelo rito externo.</p>
